...
{
name:"WEST AFRICA",
bg:"linear-gradient(#fffb00 0%, #3200d4 60%, #ff0000 100%)",
platform:()=>["#9c4900","#382700","#794900"][(Math.random()*3)|0],
sprite:"sister.png",
song:"songs/s11.mp3"
},
{
...
return {
  x: Math.round(sx / PS1_SNAP) * PS1_SNAP,
  y: Math.round(sy / PS1_SNAP) * PS1_SNAP,
  z
}
}
...
const nextTheme=Math.min(themes.length-1,Math.floor(platformCount/80))
...
x.drawImage(rc, jitterX, jitterY, W, H)
x.globalAlpha=0.6
x.drawImage(rc, jitterX, jitterY, W, H)
x.globalAlpha=1
for(let y=0;y<H;y+=2){
